...
def _seed_logic():
    """Core seed logic — must be called inside an active app context."""
    db.create_all()
...
<p>需有至少 6 個月刺青實操經驗。</p>""",
        ...
        },
        {
            ...
            "description": "系統性學習日式刺青的傳統圖騰、配色規則與構圖美學。",
            "content": """<h2>課程大綱</h2>
<h3>理論模組（2小時）</h3>
<ul>
<li>日式刺青歷史與圖騰意涵</li>
...
<p>含親筆簽名結業証書。</p>""",
        ...
        },
        {
            ...
            "description": "教你用最少的線條傳遞最強的視覺衝擊。適合想學習細線風格的刺青師。",
            "content": """<h2>課程內容</h2>
<ul>
<li>細針使用技巧（0.35mm 以下）</li>
<li>線條張力與間距美學</li>
<li>負空間運用</li>
<li>從草圖到成品的完整流程</li>
</ul>
<p>一天密集課，含材料費。</p>""",
        ...
        },
        {
            ...
            "content": """<h2>課程模組</h2>
<h3>法規與執照</h3>
<ul><li>衛生局規範與申請流程</li><li>消費者保護注意事項</li></ul>
<h3>空間與設備</h3>
<ul><li>工作室選址與裝潢建議</li><li>設備採購清單與預算規劃</li></ul>
<h3>品牌與行銷</h3>
<ul><li>作品集拍攝技巧</li><li>IG 演算法與貼文策略</li><li>定價心理學與套餐設計</li></ul>
<h3>客戶關係</h3>
<ul><li>諮詢流程標準化</li><li>售後追蹤與口碑建立</li></ul>
<p>共 8 小時，分兩個半天上課。</p>""",
            "price": 9800,
            "max_students": 8,
